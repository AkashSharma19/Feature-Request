...
export default function WelcomePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-teal-50 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-50 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000" />
      
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 border border-teal-100 text-teal-600 text-xs font-bold mb-8 animate-fade-in">
          <Sparkles size={12} />
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 tracking-tight mb-6 animate-slide-up">
          What features should we build <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-600">next?</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up animation-delay-1000">
          <div className="flex items-center gap-6 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 bg-teal-50 text-teal-600 rounded-xl flex items-center justify-center mb-2">
                <Star size={20} />
              </div>
        ...
        <div className="absolute -bottom-8 -right-8 animate-bounce animation-delay-2000">
          <div className="bg-white p-3 rounded-2xl shadow-xl border border-teal-100 flex items-center gap-3">
